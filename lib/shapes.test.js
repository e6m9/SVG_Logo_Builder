...
describe('Shape', () => {
    ...
    test('it renders correctly', () => {
        ...
        expect(square.render()).toEqual('<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"> <rect x="60" y="22" width="180" height="200" fill="green" />');
    });
...
describe('Shape class', () => {
    it('should render a green circle based on the coordinates', () => {
        ...
        expect(circle.render()).toEqual('<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"> <circle cx="150" cy="100" r="80" fill="red" />');
    });
})
